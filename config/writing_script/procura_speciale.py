...
def write_procura_speciale(pratica):
    ...
    if pratica.cr_tipo == 'Persona Fisica':
        paragraph_2.add_run("Il sottoscritto, Avv. Antonio MAZZA, nato a Catanzaro, il 6 febbraio 1967, codice fiscale MZZNTN67B06C352G, "
                            ...
                            f"nel procedimento monitorio n.PrAn.1 R.G. del CA di AA, di {pratica.cr_cognome} {pratica.cr_nome}, luogo di nascita {pratica.cr_luogo_di_nascita}, data nascita {pratica.cr_data_di_nascita}, "
                            f"residenza in {pratica.cr_comune_di_residenza}, {pratica.cr_indirizzo_di_residenza}, codice fiscale {pratica.cr_codice_fiscale}, rappresentato e difeso da sé medesimo, ex art.86 c.p.c., "
        ...
        if pratica.cr_partita_iva is None:
            paragraph_2.add_run("Il sottoscritto, Avv. Antonio MAZZA, nato a Catanzaro, il 6 febbraio 1967, codice fiscale MZZNTN67B06C352G, "
                                "con studio in Milano, Via Lovanio n.10, pec avv.antoniomazza@pec.giuffrè.it, in qualità di procuratore antistatario, "
                                f"nel procedimento monitorio n.PrAn.1 R.G. del CA di AA, {pratica.cr_denominazione_sociale}, in persona del legale rappresentante pro tempore, con sede in {pratica.cr_comune_sede_principale}, {pratica.cr_indirizzo_sede_principale}, "
                                f"codice fiscale {pratica.cr_codice_fiscale}, rappresentato e difeso da sé medesimo, ex art.86 c.p.c., ed elettivamente domiciliato presso "
                                "il proprio studio in Milano – Via Lovanio 10;", 'ParagraphStyle')
        elif pratica.cr_codice_fiscale is None:
            paragraph_2.add_run("Il sottoscritto, Avv. Antonio MAZZA, nato a Catanzaro, il 6 febbraio 1967, codice fiscale MZZNTN67B06C352G, "
                                "con studio in Milano, Via Lovanio n.10, pec avv.antoniomazza@pec.giuffrè.it, in qualità di procuratore antistatario, "
                                f"nel procedimento monitorio n.PrAn.1 R.G. del CA di AA, {pratica.cr_denominazione_sociale}, in persona del legale rappresentante pro tempore, con sede in {pratica.cr_comune_sede_principale}, {pratica.cr_indirizzo_sede_principale}, "
                                f"partita IVA {pratica.cr_partita_iva}, rappresentato e difeso da sé medesimo, ex art.86 c.p.c., ed elettivamente domiciliato presso "
                                "il proprio studio in Milano – Via Lovanio 10;", 'ParagraphStyle')
        elif pratica.cr_partita_iva and pratica.cr_codice_fiscale is not None:
            paragraph_2.add_run("Il sottoscritto, Avv. Antonio MAZZA, nato a Catanzaro, il 6 febbraio 1967, codice fiscale MZZNTN67B06C352G, "
                                "con studio in Milano, Via Lovanio n.10, pec avv.antoniomazza@pec.giuffrè.it, in qualità di procuratore antistatario, "
                                f"nel procedimento monitorio n.PrAn.1 R.G. del CA di AA, {pratica.cr_denominazione_sociale}, in persona del legale rappresentante pro tempore, con sede in {pratica.cr_comune_sede_principale}, {pratica.cr_indirizzo_sede_principale}, "
                                f"codice fiscale {pratica.cr_codice_fiscale}, partita IVA {pratica.cr_partita_iva}, rappresentato e difeso da sé medesimo, ex art.86 c.p.c., ed elettivamente domiciliato presso "
                                "il proprio studio in Milano – Via Lovanio 10;", 'ParagraphStyle')
    ...
    if pratica.cr_tipo == 'Persona Fisica':
        paragraph_4.add_run("il contenuto -da intendersi qui integralmente trascritto- del decreto ingiuntivo n. Pr.1, notificato il Pr.2, esecutivo con apposizione della formula di rito in data Pr.3, "
                            f"col quale il CA di AA, su ricorso presentato da {pratica.cr_cognome} {pratica.cr_nome}, luogo di nascita {pratica.cr_luogo_di_nascita},  data nascita {pratica.cr_data_di_nascita}, residenza in A.1.5, A.1.6, "
                            f"codice fiscale {pratica.cr_codice_fiscale}, ingiungeva a", 'ParagraphStyle')
    elif pratica.cr_tipo == 'Persona Giuridica':
        if pratica.cr_partita_iva is None:
            paragraph_4.add_run("il contenuto -da intendersi qui integralmente trascritto- del decreto ingiuntivo n. Pr.1, notificato il Pr.2, esecutivo con apposizione della formula di rito in data Pr.3, "
                                f"col quale il CA di AA, su ricorso presentato da {pratica.cr_denominazione_sociale}, in persona del legale rappresentante pro tempore, "
                                f"con sede in {pratica.cr_comune_sede_principale}, {pratica.cr_indirizzo_sede_principale}, codice fiscale {pratica.cr_codice_fiscale}, ingiungeva a", 'ParagraphStyle')
        elif pratica.cr_codice_fiscale is None:
            paragraph_4.add_run("il contenuto -da intendersi qui integralmente trascritto- del decreto ingiuntivo n. Pr.1, notificato il Pr.2, esecutivo con apposizione della formula di rito in data Pr.3, "
                                f"col quale il CA di AA, su ricorso presentato da {pratica.cr_denominazione_sociale}, in persona del legale rappresentante pro tempore, "
                                f"con sede in {pratica.cr_comune_sede_principale}, {pratica.cr_indirizzo_sede_principale}, partita IVA {pratica.cr_partita_iva}, ingiungeva a", 'ParagraphStyle')
        elif pratica.cr_partita_iva and pratica.cr_codice_fiscale is not None:
            paragraph_4.add_run("il contenuto -da intendersi qui integralmente trascritto- del decreto ingiuntivo n. Pr.1, notificato il Pr.2, esecutivo con apposizione della formula di rito in data Pr.3, "
                                f"col quale il CA di AA, su ricorso presentato da {pratica.cr_denominazione_sociale}, in persona del legale rappresentante pro tempore, "
                                f"con sede in {pratica.cr_comune_sede_principale}, {pratica.cr_indirizzo_sede_principale}, codice fiscale {pratica.cr_codice_fiscale}, partita IVA {pratica.cr_partita_iva}, ingiungeva a", 'ParagraphStyle')
    ...
    if pratica.db_tipo == 'Persona Fisica':
        paragraph_5.add_run(f"{pratica.db_cognome} {pratica.db_nome}, luogo nascita {pratica.db_luogo_di_nascita}, data nascita {pratica.db_data_di_nascita}, residenza in B.1.5, {pratica.db_indirizzo_di_residenza}, "
                            f"codice fiscale {pratica.df_codice_fiscale}, ", 'ParagraphStyle')
    else:
        paragraph_5.add_run(
            f"{pratica.db_denominazione_sociale}, con sede in B.2.2, {pratica.db_sede_principale}, codice fiscale {pratica.dj_codice_fiscale}, partita IVA {pratica.dj_partita_iva}, ", 'ParagraphStyle')
    ...
    paragraph_6.add_run(f"di pagare a parte ricorrente, per la causali di cui al ricorso, la somma di €. {pratica.somma}, oltre interessi Pr.4, "
    ...
    if pratica.db_tipo == 'Persona Fisica':
        paragraph_8.add_run(f"{pratica.db_cognome} {pratica.db_nome}, luogo nascita {pratica.db_luogo_di_nascita}, data nascita {pratica.db_data_di_nascita}, residenza in B.1.5, {pratica.db_indirizzo_di_residenza}, "
                            f"codice fiscale {pratica.df_codice_fiscale}, ", 'ParagraphStyle')
    else:
        paragraph_8.add_run(
            f"{pratica.db_denominazione_sociale}, con sede in B.2.2, {pratica.db_sede_principale}, codice fiscale {pratica.dj_codice_fiscale}, partita IVA {pratica.dj_partita_iva}, ", 'ParagraphStyle')
