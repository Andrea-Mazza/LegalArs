...
def write_procura_speciale(pratica):
    ...
    if pratica.cr_tipo == 'Persona Fisica':
        ...
        elif pratica.cr_codice_fiscale and pratica.cr_partita_iva is not None:
